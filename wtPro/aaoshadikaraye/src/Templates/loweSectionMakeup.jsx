...
const LowerSectionMakeup = ({ venue, rating, location, makeuptype, price, img }) => {
  return (
    <div className={styles.lowerDiv}>
      <img src={img} className={styles.cardImage} alt="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSTolIaZfJG1ctcl4Bay_l9qxE0LXUrmSVkId7KHBJSIg&s"></img>
